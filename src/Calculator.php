...
namespace Drupal\simple_calculator;

/**
 * Class Calculator.
 *
 * @package Drupal\simple_calculator
 */
class Calculator {

  /**
   * Lexical parser on a given arithmetic expression
   *
   ...
   *
   */
  public static function parser($expression) {
